...
// 				}
		...
		// Map actions.<name>.exclude.n → rsyncControls.exclusions
		if (actionSpec.exclude) {
			const exclusions = Array.isArray(actionSpec.exclude)
				? actionSpec.exclude
				: Object.values(actionSpec.exclude);
			expandedActionSet.rsyncControls = {
				...expandedActionSet.rsyncControls,
				exclusions
			};
		}
